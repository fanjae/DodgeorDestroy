...
| 항목 | 내용 |
|---|---|
| 프로젝트명 | DodgeOrDestroy |
| 개발 기간 | 2026.06.09 ~ 2026.06.09 |
| 개발 인원 | 1명 |
| 개발 환경 | Unity, C# |
| 실행 환경 | Windows |
...
3. 압축 해제된 폴더에서 DodgeorDestroy.exe를 실행합니다.

## 구현 기능

### ① 플레이어 시스템
- Input System 기반 이동 및 공격 구현
- 방향 전환 애니메이션 적용

### ② 적 시스템
- 코루틴 기반 적 생성
- 랜덤 스폰 및 다양한 이동 패턴 구현
- 적 HP 및 공격 기능 구현
...
## 플레이 영상
[플레이 영상](https://youtu.be/brMrfpSary4)
